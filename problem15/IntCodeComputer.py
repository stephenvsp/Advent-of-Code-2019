...
def run_program(int_code, input_val, loop=False, pc=0, rb=0):
    ...
    while pc < len(int_code):
        ...
        # 4 - print out position
            ...
            if loop:
                return output_val, pc + increment, relative_base
        ...
        # 99 - halt
            ...
            if loop:
                return output_val, None, None
            break

        else:
            print.append('you done fucked up')
            break
